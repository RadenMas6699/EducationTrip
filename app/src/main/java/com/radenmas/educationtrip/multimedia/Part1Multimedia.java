...
public class Part1Multimedia extends AppCompatActivity {
    ...
    private int scorepart1multimedia = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        updateScore(scorepart1multimedia);
        countDown();
        updateQuestion();
    }
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Part1Multimedia.this, MapsMultimedia.class);
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalMultimedia.getLength1() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalMultimedia.getQuestion1(mQuestionNumber));
            choice1.setText(bankSoalMultimedia.getChoice1(mQuestionNumber, 1));
            choice2.setText(bankSoalMultimedia.getChoice1(mQuestionNumber, 2));
            choice3.setText(bankSoalMultimedia.getChoice1(mQuestionNumber, 3));
            choice4.setText(bankSoalMultimedia.getChoice1(mQuestionNumber,4));
            mAnswer = bankSoalMultimedia.getCorrectAnswer1(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart1multimedia >=0 && scorepart1multimedia < 30){
                int starpart1multimedia = 0;
                editor.putInt("starpart1multimedia", starpart1multimedia);
                editor.apply();
            }
            else if (scorepart1multimedia == 30){
                int starpart1multimedia = 1;
                editor.putInt("starpart1multimedia", starpart1multimedia);
                editor.apply();
            }
            else if (scorepart1multimedia == 40){
                int starpart1multimedia = 2;
                editor.putInt("starpart1multimedia", starpart1multimedia);
                editor.apply();
            }
            else if (scorepart1multimedia == 50){
                int starpart1multimedia = 3;
                editor.putInt("starpart1multimedia", starpart1multimedia);
                editor.apply();
            }
            Intent intent = new Intent(Part1Multimedia.this, MapsMultimedia.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart1multimedia = scorepart1multimedia + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part1Multimedia.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part1Multimedia.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part1Multimedia.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent menu = new Intent(Part1Multimedia.this, MenuPlay.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    private void updateScore(int scorepart1multimedia) {
        koinText.setText("" +scorepart1multimedia);
    }
