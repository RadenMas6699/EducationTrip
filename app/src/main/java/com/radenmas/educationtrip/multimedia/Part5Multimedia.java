...
public class Part5Multimedia extends AppCompatActivity {
    ...
    private int scorepart5multimedia = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        updateScore(scorepart5multimedia);
        countDown();
        updateQuestion();
    }
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Part5Multimedia.this, MapsMultimedia.class);
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalMultimedia.getLength5() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalMultimedia.getQuestion5(mQuestionNumber));
            choice1.setText(bankSoalMultimedia.getChoice5(mQuestionNumber, 1));
            choice2.setText(bankSoalMultimedia.getChoice5(mQuestionNumber, 2));
            choice3.setText(bankSoalMultimedia.getChoice5(mQuestionNumber, 3));
            choice4.setText(bankSoalMultimedia.getChoice5(mQuestionNumber,4));
            mAnswer = bankSoalMultimedia.getCorrectAnswer5(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart5multimedia >=0 && scorepart5multimedia < 30){
                int starpart5multimedia = 0;
                editor.putInt("starpart5multimedia", starpart5multimedia);
                editor.apply();
            }
            else if (scorepart5multimedia == 30){
                int starpart5multimedia = 1;
                editor.putInt("starpart5multimedia", starpart5multimedia);
                editor.apply();
            }
            else if (scorepart5multimedia == 40){
                int starpart5multimedia = 2;
                editor.putInt("starpart5multimedia", starpart5multimedia);
                editor.apply();
            }
            else if (scorepart5multimedia == 50){
                int starpart5multimedia = 3;
                editor.putInt("starpart5multimedia", starpart5multimedia);
                editor.apply();
            }
            Intent intent = new Intent(Part5Multimedia.this, ResultMultimedia.class);
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            finish();
        }
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart5multimedia = scorepart5multimedia + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part5Multimedia.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part5Multimedia.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part5Multimedia.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent menu = new Intent(Part5Multimedia.this, MenuPlay.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    private void updateScore(int scorepart5multimedia) {
        koinText.setText("" +scorepart5multimedia);
    }
