...
public class Part4Multimedia extends AppCompatActivity {
    ...
    private int scorepart4multimedia = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        updateScore(scorepart4multimedia);
        countDown();
        updateQuestion();
    }
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Part4Multimedia.this, MapsMultimedia.class);
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalMultimedia.getLength4() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalMultimedia.getQuestion4(mQuestionNumber));
            choice1.setText(bankSoalMultimedia.getChoice4(mQuestionNumber, 1));
            choice2.setText(bankSoalMultimedia.getChoice4(mQuestionNumber, 2));
            choice3.setText(bankSoalMultimedia.getChoice4(mQuestionNumber, 3));
            choice4.setText(bankSoalMultimedia.getChoice4(mQuestionNumber,4));
            mAnswer = bankSoalMultimedia.getCorrectAnswer4(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart4multimedia >=0 && scorepart4multimedia < 30){
                int starpart4multimedia = 0;
                editor.putInt("starpart4multimedia", starpart4multimedia);
                editor.apply();
            }
            else if (scorepart4multimedia == 30){
                int starpart4multimedia = 1;
                editor.putInt("starpart4multimedia", starpart4multimedia);
                editor.apply();
            }
            else if (scorepart4multimedia == 40){
                int starpart4multimedia = 2;
                editor.putInt("starpart4multimedia", starpart4multimedia);
                editor.apply();
            }
            else if (scorepart4multimedia == 50){
                int starpart4multimedia = 3;
                editor.putInt("starpart4multimedia", starpart4multimedia);
                editor.apply();
            }
            Intent intent = new Intent(Part4Multimedia.this, MapsMultimedia.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart4multimedia = scorepart4multimedia + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part4Multimedia.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part4Multimedia.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part4Multimedia.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent menu = new Intent(Part4Multimedia.this, MenuPlay.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    private void updateScore(int scorepart4multimedia) {
        koinText.setText("" +scorepart4multimedia);
    }
