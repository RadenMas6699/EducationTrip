...
public class Part3Multimedia extends AppCompatActivity {
    ...
    private int scorepart3multimedia = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        updateScore(scorepart3multimedia);
        countDown();
        updateQuestion();
    }
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Part3Multimedia.this, MapsMultimedia.class);
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalMultimedia.getLength3() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalMultimedia.getQuestion3(mQuestionNumber));
            choice1.setText(bankSoalMultimedia.getChoice3(mQuestionNumber, 1));
            choice2.setText(bankSoalMultimedia.getChoice3(mQuestionNumber, 2));
            choice3.setText(bankSoalMultimedia.getChoice3(mQuestionNumber, 3));
            choice4.setText(bankSoalMultimedia.getChoice3(mQuestionNumber,4));
            mAnswer = bankSoalMultimedia.getCorrectAnswer3(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart3multimedia >=0 && scorepart3multimedia < 30){
                int starpart3multimedia = 0;
                editor.putInt("starpart3multimedia", starpart3multimedia);
                editor.apply();
            }
            else if (scorepart3multimedia == 30){
                int starpart3multimedia = 1;
                editor.putInt("starpart3multimedia", starpart3multimedia);
                editor.apply();
            }
            else if (scorepart3multimedia == 40){
                int starpart3multimedia = 2;
                editor.putInt("starpart3multimedia", starpart3multimedia);
                editor.apply();
            }
            else if (scorepart3multimedia == 50){
                int starpart3multimedia = 3;
                editor.putInt("starpart3multimedia", starpart3multimedia);
                editor.apply();
            }
            Intent intent = new Intent(Part3Multimedia.this, MapsMultimedia.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart3multimedia = scorepart3multimedia + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part3Multimedia.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part3Multimedia.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part3Multimedia.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent menu = new Intent(Part3Multimedia.this, MenuPlay.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    private void updateScore(int scorepart3multimedia) {
        koinText.setText("" +scorepart3multimedia);
    }
