...
public class Part2RPL extends AppCompatActivity {
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Part2RPL.this, MapsRPL.class);
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalRPL.getLength2() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalRPL.getQuestion2(mQuestionNumber));
            choice1.setText(bankSoalRPL.getChoice2(mQuestionNumber, 1));
            choice2.setText(bankSoalRPL.getChoice2(mQuestionNumber, 2));
            choice3.setText(bankSoalRPL.getChoice2(mQuestionNumber, 3));
            choice4.setText(bankSoalRPL.getChoice2(mQuestionNumber,4));
            mAnswer = bankSoalRPL.getCorrectAnswer2(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart2rpl >=0 && scorepart2rpl < 30){
                int starpart2rpl = 0;
                editor.putInt("starpart2rpl", starpart2rpl);
                editor.apply();
            }
            else if (scorepart2rpl == 30){
                int starpart2rpl = 1;
                editor.putInt("starpart2rpl", starpart2rpl);
                editor.apply();
            }
            else if (scorepart2rpl == 40){
                int starpart2rpl = 2;
                editor.putInt("starpart2rpl", starpart2rpl);
                editor.apply();
            }
            else if (scorepart2rpl == 50){
                int starpart2rpl = 3;
                editor.putInt("starpart2rpl", starpart2rpl);
                editor.apply();
            }
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart2rpl = scorepart2rpl + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part2RPL.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part2RPL.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part2RPL.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent menu = new Intent(Part2RPL.this, MenuPlay.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    private void updateScore(int scorepart2rpl) {
        koinText.setText("" +scorepart2rpl);
    }
