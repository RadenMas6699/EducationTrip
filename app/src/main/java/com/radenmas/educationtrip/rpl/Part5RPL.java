...
public class Part5RPL extends AppCompatActivity {
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Part5RPL.this, MapsRPL.class);
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalRPL.getLength5() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalRPL.getQuestion5(mQuestionNumber));
            choice1.setText(bankSoalRPL.getChoice5(mQuestionNumber, 1));
            choice2.setText(bankSoalRPL.getChoice5(mQuestionNumber, 2));
            choice3.setText(bankSoalRPL.getChoice5(mQuestionNumber, 3));
            choice4.setText(bankSoalRPL.getChoice5(mQuestionNumber,4));
            mAnswer = bankSoalRPL.getCorrectAnswer5(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart5rpl >=0 && scorepart5rpl < 30){
                int starpart5rpl = 0;
                editor.putInt("starpart5rpl", starpart5rpl);
                editor.apply();
            }
            else if (scorepart5rpl == 30){
                int starpart5rpl = 1;
                editor.putInt("starpart5rpl", starpart5rpl);
                editor.apply();
            }
            else if (scorepart5rpl == 40){
                int starpart5rpl = 2;
                editor.putInt("starpart5rpl", starpart5rpl);
                editor.apply();
            }
            else if (scorepart5rpl == 50){
                int starpart5rpl = 3;
                editor.putInt("starpart5rpl", starpart5rpl);
                editor.apply();
            }
            Intent intent = new Intent(Part5RPL.this, ResultRPL.class);
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            finish();
        }
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart5rpl = scorepart5rpl + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part5RPL.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part5RPL.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part5RPL.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent menu = new Intent(Part5RPL.this, MenuPlay.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    private void updateScore(int scorepart5rpl) {
        koinText.setText("" +scorepart5rpl);
    }
