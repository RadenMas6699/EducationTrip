...
public class Part4RPL extends AppCompatActivity {
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Part4RPL.this, MapsRPL.class);
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalRPL.getLength4() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalRPL.getQuestion4(mQuestionNumber));
            choice1.setText(bankSoalRPL.getChoice4(mQuestionNumber, 1));
            choice2.setText(bankSoalRPL.getChoice4(mQuestionNumber, 2));
            choice3.setText(bankSoalRPL.getChoice4(mQuestionNumber, 3));
            choice4.setText(bankSoalRPL.getChoice4(mQuestionNumber,4));
            mAnswer = bankSoalRPL.getCorrectAnswer4(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart4rpl >=0 && scorepart4rpl < 30){
                int starpart4rpl = 0;
                editor.putInt("starpart4rpl", starpart4rpl);
                editor.apply();
            }
            else if (scorepart4rpl == 30){
                int starpart4rpl = 1;
                editor.putInt("starpart4rpl", starpart4rpl);
                editor.apply();
            }
            else if (scorepart4rpl == 40){
                int starpart4rpl = 2;
                editor.putInt("starpart4rpl", starpart4rpl);
                editor.apply();
            }
            else if (scorepart4rpl == 50){
                int starpart4rpl = 3;
                editor.putInt("starpart4rpl", starpart4rpl);
                editor.apply();
            }
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart4rpl = scorepart4rpl + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part4RPL.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part4RPL.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part4RPL.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent menu = new Intent(Part4RPL.this, MenuPlay.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    private void updateScore(int scorepart4rpl) {
        koinText.setText("" +scorepart4rpl);
    }
