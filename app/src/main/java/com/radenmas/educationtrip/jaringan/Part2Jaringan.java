...
public class Part2Jaringan extends AppCompatActivity {
    ...
    private int scorepart2jaringan = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        updateScore(scorepart2jaringan);
        countDown();
        updateQuestion();
    }
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Part2Jaringan.this, MapsJaringan.class);
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalJaringan.getLength2() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalJaringan.getQuestion2(mQuestionNumber));
            choice1.setText(bankSoalJaringan.getChoice2(mQuestionNumber, 1));
            choice2.setText(bankSoalJaringan.getChoice2(mQuestionNumber, 2));
            choice3.setText(bankSoalJaringan.getChoice2(mQuestionNumber, 3));
            choice4.setText(bankSoalJaringan.getChoice2(mQuestionNumber,4));
            mAnswer = bankSoalJaringan.getCorrectAnswer2(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart2jaringan >=0 && scorepart2jaringan < 30){
                int starpart2jaringan = 0;
                editor.putInt("starpart2jaringan", starpart2jaringan);
                editor.apply();
            }
            else if (scorepart2jaringan == 30){
                int starpart2jaringan = 1;
                editor.putInt("starpart2jaringan", starpart2jaringan);
                editor.apply();
            }
            else if (scorepart2jaringan == 40){
                int starpart2jaringan = 2;
                editor.putInt("starpart2jaringan", starpart2jaringan);
                editor.apply();
            }
            else if (scorepart2jaringan == 50){
                int starpart2jaringan = 3;
                editor.putInt("starpart2jaringan", starpart2jaringan);
                editor.apply();
            }
            Intent intent = new Intent(Part2Jaringan.this, MapsJaringan.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart2jaringan = scorepart2jaringan + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part2Jaringan.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part2Jaringan.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part2Jaringan.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent menu = new Intent(Part2Jaringan.this, MenuPlay.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    private void updateScore(int scorepart2jaringan) {
        koinText.setText("" +scorepart2jaringan);
    }
