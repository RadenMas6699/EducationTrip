...
public class Part1Jaringan extends AppCompatActivity {
    ...
    private int scorepart1jaringan = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        updateScore(scorepart1jaringan);
        countDown();
        updateQuestion();
    }
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Part1Jaringan.this, MapsJaringan.class));
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalJaringan.getLength1() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalJaringan.getQuestion1(mQuestionNumber));
            choice1.setText(bankSoalJaringan.getChoice1(mQuestionNumber, 1));
            choice2.setText(bankSoalJaringan.getChoice1(mQuestionNumber, 2));
            choice3.setText(bankSoalJaringan.getChoice1(mQuestionNumber, 3));
            choice4.setText(bankSoalJaringan.getChoice1(mQuestionNumber,4));
            mAnswer = bankSoalJaringan.getCorrectAnswer1(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart1jaringan >=0 && scorepart1jaringan < 30){
                int starpart1jaringan = 0;
                editor.putInt("starpart1jaringan", starpart1jaringan);
                editor.apply();
            }
            else if (scorepart1jaringan == 30){
                int starpart1jaringan = 1;
                editor.putInt("starpart1jaringan", starpart1jaringan);
                editor.apply();
            }
            else if (scorepart1jaringan == 40){
                int starpart1jaringan = 2;
                editor.putInt("starpart1jaringan", starpart1jaringan);
                editor.apply();
            }
            else if (scorepart1jaringan == 50){
                int starpart1jaringan = 3;
                editor.putInt("starpart1jaringan", starpart1jaringan);
                editor.apply();
            }

            Intent intent = new Intent(Part1Jaringan.this, MapsJaringan.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart1jaringan = scorepart1jaringan + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part1Jaringan.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part1Jaringan.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part1Jaringan.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Part1Jaringan.this, MenuPlay.class));
                finish();
            }
        });
    }

    private void updateScore(int scorepart1jaringan) {
        koinText.setText("" +scorepart1jaringan);
    }
