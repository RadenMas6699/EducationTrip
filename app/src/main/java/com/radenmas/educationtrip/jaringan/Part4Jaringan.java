...
public class Part4Jaringan extends AppCompatActivity {
    ...
    private int scorepart4jaringan = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        updateScore(scorepart4jaringan);
        countDown();
        updateQuestion();
    }
    ...
    private void init() {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Part4Jaringan.this, MapsJaringan.class);
    ...
    private void updateQuestion() {
        if(mQuestionNumber< bankSoalJaringan.getLength4() ){
            timeValue = 15;
            countDownTimer.cancel();
            countDownTimer.start();

            question.setText(bankSoalJaringan.getQuestion4(mQuestionNumber));
            choice1.setText(bankSoalJaringan.getChoice4(mQuestionNumber, 1));
            choice2.setText(bankSoalJaringan.getChoice4(mQuestionNumber, 2));
            choice3.setText(bankSoalJaringan.getChoice4(mQuestionNumber, 3));
            choice4.setText(bankSoalJaringan.getChoice4(mQuestionNumber,4));
            mAnswer = bankSoalJaringan.getCorrectAnswer4(mQuestionNumber);
            mQuestionNumber++;
        }
        else {
            ...
            if (scorepart4jaringan >=0 && scorepart4jaringan < 30){
                int starpart4jaringan = 0;
                editor.putInt("starpart4jaringan", starpart4jaringan);
                editor.apply();
            }
            else if (scorepart4jaringan == 30){
                int starpart4jaringan = 1;
                editor.putInt("starpart4jaringan", starpart4jaringan);
                editor.apply();
            }
            else if (scorepart4jaringan == 40){
                int starpart4jaringan = 2;
                editor.putInt("starpart4jaringan", starpart4jaringan);
                editor.apply();
            }
            else if (scorepart4jaringan == 50){
                int starpart4jaringan = 3;
                editor.putInt("starpart4jaringan", starpart4jaringan);
                editor.apply();
            }
            Intent intent = new Intent(Part4Jaringan.this, MapsJaringan.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            scorepart4jaringan = scorepart4jaringan + 10;
    ...
    public void correctDialog() {
        ...
        mediaPlayer.start();
        final Dialog dialogCorrect = new Dialog(Part4Jaringan.this);
    ...
    public void gameLostPlayAgain() {
        ...
        mediaPlayer.start();
        final Dialog dialogFalse = new Dialog(Part4Jaringan.this);
    ...
    private void gameOver() {
        ...
        mediaPlayer.start();
        final Dialog dialogGameOver = new Dialog(Part4Jaringan.this);
        ...
        game_over.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent menu = new Intent(Part4Jaringan.this, MenuPlay.class);
                startActivity(menu);
                finish();
            }
        });
    ...
    private void updateScore(int scorepart4jaringan) {
        koinText.setText("" +scorepart4jaringan);
    }
